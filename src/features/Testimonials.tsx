        ...
        >
          {testimonials.map((testimonial) => (
            <SwiperSlide key={testimonial.id}>
              <div className="bg-transparent border-2 border-gray-600 h-[300px] p-6 rounded-xl text-center shadow-lg transform transition duration-300" data-aos="fade-up" data-aos-duration="1000">
